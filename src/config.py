...
# --- تنظیمات بک‌تست ---
BACKTEST_DAYS = _get_int("BACKTEST_DAYS", 120)                  # چند روز تاریخچه کریپتو گرفته شود
BACKTEST_MAX_SYMBOLS = _get_int("BACKTEST_MAX_SYMBOLS", 12)     # چند رمزارز در بک‌تست بررسی شود
BACKTEST_MAX_HOLDING_CANDLES = _get_int("BACKTEST_MAX_HOLDING_CANDLES", 48)  # حداکثر نگه‌داری هر معامله
BACKTEST_MIN_QUOTE_VOLUME_USDT = _get_float("BACKTEST_MIN_QUOTE_VOLUME_USDT", 5_000_000)
BACKTEST_OUTPUT_FILE = _get_str("BACKTEST_OUTPUT_FILE", "backtest_trades.csv")
